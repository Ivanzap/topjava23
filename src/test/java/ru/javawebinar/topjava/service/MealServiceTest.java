...
import ru.javawebinar.topjava.TimingLoggerRules;
...
public class MealServiceTest {
    ...
    @ClassRule
    public static ExternalResource summary = TimingLoggerRules.SUMMARY;

    @Rule
    public Stopwatch stopwatch = TimingLoggerRules.STOPWATCH;
